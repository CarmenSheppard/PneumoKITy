...
`docker run --rm -v /path/to/local/input:/app/input -v /path/to/local/output:/app/output pneumokity:latest pure --input /app/input/assembly.fasta --output /app/output `
